...
public sealed class ProductCommandRepository(ShopManagementCommandDbContext dbContext) :
    BaseCommandRepository<Product, ShopManagementCommandDbContext, int>(dbContext),
